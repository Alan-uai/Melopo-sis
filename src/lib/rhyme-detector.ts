...
const CLICHE_RHYME_PAIRS = new Set([
  ...
  'vida,ferida', 'ferida,vida', 'paixão,coração', 'coração,paixão',
  'flor,amor', 'amor,flor', 'pranto,canto', 'canto,pranto',
  'mar,cantar', 'cantar,mar', 'sozinho,caminho', 'caminho,sozinho',
  'mundo,profundo', 'profundo,mundo', 'céu,véu', 'véu,céu',
  'sol,farol', 'farol,sol', 'ventura,ternura', 'ternura,ventura',
]);
